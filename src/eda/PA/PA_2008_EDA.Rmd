...
hmda_data_pa <- fread(paste(data_dir, "/2008/hmda_2008_pa_all-records_labels.csv", sep = ""))
```
...
hmda_data_pa_df_imputed <- mice(hmda_pa_df, m=1, maxit=2, meth='cart',seed=500)
...
write.csv(hmda_data_pa_df_imputed, paste(data_dir, "/2008/hmda_2008_pa_imputed.csv", sep = ""), row.names = FALSE)
```
