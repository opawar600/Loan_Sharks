---
title: "Logistic Regression for Loansharks (2017 Pennsylvania)"
...
```{r}
hmda_data_df_ <- fread(paste(data_dir, "/HMDA/2017/hmda_2017_pa_imputed.csv", sep=""))
...
```{r}
period_list <- c("2017-01", "2017-02", "2017-03", "2017-04",
...
```{r}
model_2017_with_loan_to_value_ratio <-
...
model_summary_and_plot(model_2017_with_loan_to_value_ratio, train = new_train)
mcfadden_r_square(model_2017_with_loan_to_value_ratio, null_model)
...
model6_fitted.probs <- predict(model_2017_with_loan_to_value_ratio, new_test, type = "response")
...
save(model_2017_income_loan_amount, file = paste(model_path, "/model_income_loan_amount.rdata", sep=""))
save(model_2017_log_income_loan_amount, file = paste(model_path, "/model_log_income_loan_amount.rdata", sep=""))
save(model_2017_ratio_of_loan_to_income_with_log_of_income_and_amount, file = paste(model_path, "/model_loan_income_ratio_with_log_of_income_and_amount.rdata", sep=""))
save(model_2017_cross_val_loan_income_ratio, file = paste(model_path, "/cross_val_model.rdata", sep=""))
save(merged_2017_model, file = paste(model_path, "/merged_model.rdata", sep=""))

save(model_2017_with_loan_to_value_ratio, file = paste(model_path, "/merged_model_with_loan_to_value.rdata", sep=""))
```
